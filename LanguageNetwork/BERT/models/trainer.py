...
from utils.dataio import save_txt_file
from utils.utils import test_rouge, rouge_results_to_str
...
def build_trainer(args, device_id, model, optim):
    ...
    Args:
        ...
        model (:obj:`onmt.models.NMTModel`): the models to train
        fields (dict): dict of fields
        optim (:obj:`onmt.utils.Optimizer`): optimizer used during training
        data_type (str): string describing the type of data
            e.g. "text", "img", "audio"
        model_saver(:obj:`onmt.models.ModelSaverBase`): the utility object
            used to save the models
    """
...
class Trainer(object):
    ...
    Args:
            model(:py:class:`onmt.models.models.NMTModel`): translation models
                to train
            train_loss(:obj:`onmt.utils.loss.LossComputeBase`):
               training loss computation
            valid_loss(:obj:`onmt.utils.loss.LossComputeBase`):
               training loss computation
            optimizer(:obj:`onmt.utils.optimizers.Optimizer`):
    ...
    def __init__(self, args, model, optimizer, grad_accum_count=1, n_gpu=1, gpu_rank=1, report_manager=None):
        # Basic attributes.
        self.args = args
    ...
    def _maybe_save(self, step):
        """
        Save the models if a models saver is set
        """
