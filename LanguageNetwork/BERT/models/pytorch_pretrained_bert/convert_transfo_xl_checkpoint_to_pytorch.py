...
def convert_transfo_xl_checkpoint_to_pytorch(tf_checkpoint_path,
    ...
    if tf_checkpoint_path:
        # Convert a pre-trained TensorFlow models
        ...
        print(f"Building PyTorch models from configuration: {str(config)}")
        ...
        print(f"Save PyTorch models to {os.path.abspath(pytorch_weights_dump_path)}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pytorch_dump_folder_path",
                        ...
                        type = str,
                        required = True,
                        help = "Path to the folder to store the PyTorch models or dataset/vocab.")
    ...
    parser.add_argument("--transfo_xl_config_file",
                        default = "",
                        type = str,
                        help = "An optional config json file corresponding to the pre-trained BERT models. \n"
